...
insert into relationship_type(rl_name,rl_listcount,rl_us_num) 
values('FriendList',4,2000);
insert into relationship_type(rl_name,rl_listcount,rl_us_num) 
values('BlockList',8,2001);
...
insert into tickets(users_name,tick_number,tick_tt_id) values('Ana Banana',101,2);
insert into tickets(users_name,tick_number,tick_tt_id) values('Mauricio Pequeno',102,3);
